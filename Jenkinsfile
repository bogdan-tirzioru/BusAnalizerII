pipeline {
  ...
  environment {
    REPOSITORY_URL = 'https://github.com/bogdan-tirzioru/BusAnalizerII.git'
...
'''
  ...
  post {
    always {
      archiveArtifacts artifacts: 'cubeide-build.log,git-commit.txt,git-describe.txt,firmware-size.txt,firmware.sha256,firmBoard735/Debug/*.elf,firmBoard735/Debug/*.map,firmBoard735/Debug/*.hex,firmBoard735/Debug/*.bin',
