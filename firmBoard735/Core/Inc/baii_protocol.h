...
/* BusAnalyzerII host protocol v0.1. */
...
/* Capability bits returned by GET_INFO. */
...
/* Logical CAN channels exposed to the PC. */
...
/* Wire-level frame format selection. */
