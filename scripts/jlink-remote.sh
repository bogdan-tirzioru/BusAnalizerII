...
TELNET_PORT="19022"
RTT_PORT="19023"
SERVER_NAME="BusAnalyzerII"
LOG_FILE="$HOME/jlink-gdb-busanalyzerii.log"
PID_FILE="$HOME/jlink-gdb-busanalyzerii.pid"
LEGACY_PID_FILE="$HOME/jlink-remote-busanalyzerii.pid"
